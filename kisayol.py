...
def messagebox_ve_buttonlari_goster():
    messagebox.showinfo("Yusuf !!", "Merhaba nasılsın ?!")
    butonlari_goster()
...
button_epic = tk.Button(root, text="Overwolf", command=lambda: programi_ac("C:\Program Files (x86)\Overwolf/overwolf.exe"))
